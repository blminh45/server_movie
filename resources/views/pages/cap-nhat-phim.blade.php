    ...
    <div class="container">
        ...
        <div class="fb-w-40 d-in-bl f-left ">
            ...
            @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="txtname" name="tenphim" value={{$capnhatphim->ten_phim}}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="noidung" rows="8" name="tom_tat" >{{$capnhatphim->tom_tat}}</textarea>
        ...
        <div class="fb-w-40 d-in-bl f-right">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="txtname" name="thoiluong"  value={{$capnhatphim->thoi_luong}}>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="txtkhoichieu" name="ngaykhoicchieu" value={{$capnhatphim->khoi_chieu}}>
