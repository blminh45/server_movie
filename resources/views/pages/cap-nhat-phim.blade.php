        ...
        <div class="fb-w-40 d-in-bl f-left ">
            <form action="{{ url('phim/cap-nhat-phim/' .$capnhatphim->id) }}" METHOD="POST"
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file" id="poster" name="poster" <input type="file"
                        class="form-control-file" id="poster" name="hinh_anh" value="{{$capnhatphim->hinh_anh}}">
