...
<section class="wrapper">
    <div class="container">
        ...
        <div class="fb-w-40 d-in-bl f-left ">
            ...
            @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="txtname" name="tenkhachhang" value={{$khach_hangs->ten}}>
                    <small id="namemovie" class="form-text text-danger"> Vui lòng nhập tên phim!</small>
                  </div>
          
                  <div class="form-group">
                    <label for="txtname">Địa chỉ</label>
                    <input type="text" class="form-control" id="txtname" name="diachiKH" value={{$khach_hangs->dia_chi}}>
                    <small id="namemovie" class="form-text text-danger"> Vui lòng nhập tên phim!</small>
                  </div>
            <div class="form-group">
                <label for="noidung">Số điện thoại</label>
                <input class="form-control" id="noidung" rows="8" name="sodienthoai" value={{$khach_hangs->so_dien_thoai}}>
        ...
        <div class="fb-w-40 d-in-bl f-right">
                ...
                <div class="form-group">
                    <label for="txtkhoichieu">Mật khẩu</label>
                    <input type="text" class="form-control" id="txtkhoichieu" name="matkhau" value={{$khach_hangs->mat_khau}}>
